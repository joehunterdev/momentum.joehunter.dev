...
function SlotMomentCard({ moment, variant = "configure" }) {
	const cardCls = [
		"slot-moment-card",
	...
	if (variant === "ghost") return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("span", {
				className: "slot-moment-card__status",
				"aria-hidden": true
			}), /* @__PURE__ */ jsx("div", {
				className: "slot-moment-card__body",
				children: /* @__PURE__ */ jsx("span", {
					className: "slot-moment-card__name slot-moment-card__name--ghost",
					children: "New Moment"
				})
			})]
		})
...
function TimeSlotCell({ slot, date, config, mode, isGhost, isConflict, onStartScheduling, isWeekend, isToday }) {
...
function DaySection({ day, config, mode, scheduling, onStartScheduling, windowStart }) {
...
function WeeklyGrid({ days, config, mode, scheduling, onStartScheduling }) {
