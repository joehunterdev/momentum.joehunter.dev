        ...
        <div className="flex flex-wrap gap-2">
            {MOMENT_COLOR_PALETTE.map((color) => (
                <button
                    ...
                    className={`h-8 w-8 transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 ${value === color ? 'ring-2 ring-offset-2 ring-gray-400 scale-110' : 'hover:scale-105'
                        }`}
