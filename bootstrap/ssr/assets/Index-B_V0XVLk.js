...
function AddSlotPopover({ isOpen, onClose, onSelectOnce, onSelectRecurring }) {
...
function Index({ weekStart, weekEnd, config, days }) {
	...
	function handleAddMoment(_date, time, mode) {
		if (mode === "recurring") {
		...
		} else setModalDefaults({ preferred_time: time });
