...
function ViewToggle() {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "me-1 flex items-center gap-1 sm:hidden",
		children: [/* @__PURE__ */ jsx(Link, {
			href: route("daily"),
			className: ["rounded-md p-2 transition-colors", isDaily ? "text-indigo-600" : "text-gray-400 hover:text-gray-600"].join(" "),
			...
			href: route("weekly"),
			className: ["rounded-md p-2 transition-colors", isWeekly ? "text-indigo-600" : "text-gray-400 hover:text-gray-600"].join(" "),
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(ViewToggle, {}), /* @__PURE__ */ jsx("button", {
