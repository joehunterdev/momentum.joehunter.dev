...
import { a as MOMENT_COLOR_PALETTE, b as MOMENT_ICONS, c as WEEK_DAYS, o as MOMENT_FORM_SECTIONS, s as SCHEDULE_FREQUENCIES, y as ICON_CATEGORIES } from "./AuthenticatedLayout-C7pEbEWX.js";
import { n as SecondaryButton, t as Modal } from "./Modal-BpNK5mH7.js";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", { children: [
				...
				/* @__PURE__ */ jsx("div", {
					className: "mt-1 inline-flex border border-gray-200 bg-gray-50 p-1",
					children: SCHEDULE_FREQUENCIES.map((freq) => /* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => onChange("frequency", freq.value),
						className: `px-4 py-1.5 text-sm font-medium transition-all ${frequency === freq.value ? "bg-white text-indigo-600 shadow-sm" : "text-gray-500 hover:text-gray-700"}`,
						children: freq.label
					}, freq.value))
				}),
				/* @__PURE__ */ jsx(InputError, {
...
function MomentModal({ show, onClose, moment, defaultValues, onSubmit, onDelete, submitLabel }) {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					className: "moment-modal__header-actions",
					children: [moment && onDelete && !confirmingDelete && /* @__PURE__ */ jsx("button", {
						type: "button",
			...
			}), confirmingDelete ? /* @__PURE__ */ jsxs("div", {
				className: "moment-modal__body moment-modal__confirm-delete",
				children: [
					/* @__PURE__ */ jsxs("p", {
						className: "moment-modal__confirm-title",
						children: [
							"Delete \"",
							moment?.name,
							"\"?"
					...
					/* @__PURE__ */ jsx("p", {
						className: "moment-modal__confirm-body",
						children: "Past completions are kept. Future scheduled occurrences will be removed."
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "moment-modal__confirm-actions",
						children: [/* @__PURE__ */ jsx("button", {
							type: "button",
