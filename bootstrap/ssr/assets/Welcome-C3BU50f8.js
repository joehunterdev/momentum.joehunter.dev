...
var Cubes = ({ gridSize = 8, cubeSize, maxAngle = 45, radius = 3, easing = "power3.out", duration = {
	...
	const getCubeBorderColor = (row, col) => {
		...
		if (isPurpleTopBar || isPurpleLeftBar || isPurpleBottomBar || isPurpleRightPartial) return primaryColor;
		else if (isTealTopBar || isTealRightBar || isTealBottomBar || isTealLeftPartial) return secondaryColor;
