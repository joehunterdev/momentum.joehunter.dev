...
import { c as WEEK_DAYS, t as Authenticated } from "./AuthenticatedLayout-C7pEbEWX.js";
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("p", {
						className: "config-section-hint",
						children: [
							"Download your moments as a JSON file in the same shape used by the seeder. Drop it into ",
							/* @__PURE__ */ jsx("code", { children: "database/data/" }),
							" to re-seed later."
						]
					}),
					/* @__PURE__ */ jsx("div", {
...
function Edit({ config }) {
	...
	return /* @__PURE__ */ jsxs(Authenticated, {
		header: /* @__PURE__ */ jsxs("h2", {
			...
			children: ["Config", appVersion && /* @__PURE__ */ jsxs("span", {
				className: "ml-2 text-sm font-normal text-gray-400",
				children: ["v", appVersion]
			})]
		}),
		children: [
			/* @__PURE__ */ jsx(Head, { title: `Config${appVersion ? ` v${appVersion}` : ""}` }),
