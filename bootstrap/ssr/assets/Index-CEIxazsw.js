import { a as CalendarNav, i as jsToIsoDay, n as computeWindowStart, r as isOutOfOffice, t as Authenticated } from "./AuthenticatedLayout-CSoRFjTv.js";
import { i as WEEK_DAYS } from "./moments-_MXcoxL1.js";
import { t as SlotMomentIcon } from "./SlotMomentIcon-QVGcRK4R.js";
import { n as MOMENT_ICONS, t as MomentModal } from "./moments-B4AXyzke.js";
...
function TimeSlotCell({ slot, date, config, mode, isGhost, isConflict, onStartScheduling, onGhostNameChange, onGhostIconChange, ghostName, ghostIcon, isWeekend, isToday }) {
	...
	if (mode === "overview") {
		...
		return /* @__PURE__ */ jsxs("div", {
			className: [cls, emptyClickable ? "weekly-slot--overview-empty" : ""].filter(Boolean).join(" "),
			onClick: emptyClickable ? () => onStartScheduling(date, slot.time) : void 0,
			role: emptyClickable ? "button" : void 0,
			tabIndex: emptyClickable ? 0 : void 0,
			onKeyDown: emptyClickable ? (e) => {
